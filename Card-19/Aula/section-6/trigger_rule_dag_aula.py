...
default_args = {
    'owner': 'Airflow',
    'start_date': airflow.utils.dates.days_ago(1), # define a data como 1 dia antes da execução
}


# Várias funções random
...
with DAG(dag_id='trigger_rule_dag', 
    ...
    schedule_interval="@daily") as dag:# agendada para rodar todos os dias
    
    # tasks genericas para testar os triggers
