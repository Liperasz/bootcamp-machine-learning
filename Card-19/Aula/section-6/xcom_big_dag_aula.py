...
# função que gera dados ficticios
...
with DAG(dag_id='xcom_dag_big', default_args=args, schedule_interval="@once") as dag:
    ...
    # task que cria os dados
    t0 = PythonOperator(
        task_id='t0',
        python_callable=push_xcom_with_return
    )

    # task que puxa os dados
    t1 = PythonOperator(
        task_id='t1',
